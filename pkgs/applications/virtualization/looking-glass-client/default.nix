...
, libXi, libXext, wayland, wayland-protocols, libffi, libGL, expat, libbfd
}:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [
    ...
    libpthreadstubs libXScrnSaver libXau libXdmcp libXi libXext wayland wayland-protocols libffi libGL expat
    libbfd
  ];
