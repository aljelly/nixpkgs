...
, libXi, libXext, wayland, wayland-protocols, libffi, libGLU, expat, libbfd
}:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [
    ...
    libpthreadstubs libXScrnSaver libXau libXdmcp libXi libXext wayland wayland-protocols libffi libGLU expat
    libbfd
  ];
